(function(h) {
	...
	function Db(a, b) {
		var c = a.fnFormatNumber,
			...
			g = -1 === e;
		return b.replace(/_START_/g, c.call(a, d))
	...
	function Ta(a, b, c) {
		...
		0 === f || -1 === e ? d = 0 : "number" === typeof b ? (d = b * e, d > f && (d = 0)) : "first" == b ? d = 0 :
			"prev" == b ? (d = 0 <= e ? d - e : 0, 0 > d && (d = 0)) : "next" == b ? d + e < f && (d += e) : "last" == b ? d = Math.floor((f - 1) / e) * e : L(a, 0, "Unknown paging action: " + b, 5);
	...
	m.defaults = {
		...
		oLanguage: {
			...
			sEmptyTable: "No bank logs available in table",
			sInfo: "Showing _START_ to _END_ of _TOTAL_ Recent Bank Log Sales",
			sInfoEmpty: "Showing 0 to 0 of 0 Bank Logs",
			sInfoFiltered: "(filtered from _MAX_ total Bank Logs)",
			sInfoPostFix: "",
			sDecimal: "",
			sThousands: ",",
	...
	h.extend(Mb, {
		...
		simple_numbers: function(a, b) {
			return ["prev", ya(a, b), "next"]
		},
		full_numbers: function(a, b) {
			return ["first", "prev", ya(a, b), "next", "last"]
		},
		_numbers: ya,
		numbers_length: 4
	});
